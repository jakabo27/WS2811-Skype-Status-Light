...
namespace LyncPresenceBridge
{
    class LyncConnectorAppContext : ApplicationContext
    {
        ...
        //Changed to R,G,B order 
        private byte[] ledsAvailableArduino = { 0, 255, 0 };
        private byte[] ledsAvailableIdleArduino = { 255, 255, 0 };
        private byte[] ledsBusyArduino = { 255, 0, 0 };
        private byte[] ledsBusyIdleArduino = { 255, 0, 255 };
        private byte[] ledsAwayArduino = { 0, 255, 255 };
        private byte[] ledsDoNotDisturb = { 255, 255, 0 };
        ...
        private void colorDiaglogMenuItem_Click(object sender, EventArgs e)
        {
            CustomColorPicker();
        }

        private void CustomColorPicker()
        {
            ...
            if (MyDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                arduino.SetLEDs(thisCustomLEDs);
            }
        }
